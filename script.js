const FIXED_DESCRIPTIONS = {
  clinical: "우울증, 불안장애는 물론 강박증, ADHD, 조현병, 성격장애 및 트라우마 등 다양한 마음의 어려움을 과학적으로 규명하고 치료하는 요원입니다.\n\n먼저 '종합심리평가'를 통해 지능และ 기억력 등의 인지 기능(치매 선별 포함)을 정밀하게 확인하고, 정서와 성격 상태를 객관적으로 측정합니다.\n\n평가 결과를 바탕으로 내면의 원인을 명확히 이해한 뒤, 고통스러운 증상을 완화하고 삶의 방식이 건강하게 변화하도록 돕는 '근거 기반의 전문 심리치료(심리상담)'를 제공하여 당신이 마음의 상처를 치유하고 스스로 일어설 수 있도록 돕습니다.",
  
  nurse: "요즘 잠은 잘 자는지, 몸 어디가 아프거나 불편하진 않은지, 그리고 처방받은 약은 규칙적으로 잘 챙겨 드시고 있는지 전체적인 '건강 상태를 관찰하고 자료를 수집'하는 요원입니다.\n\n정신과적 증상이 안정될 수 있도록 세심하게 케어해 드리는 것은 물론, 지친 몸과 마음의 면역력을 높이고 건강한 일상 루틴을 유지할 수 있도록 다방면의 '건강증진 활동'을 기획하고 수행합니다.",
  
  social: "마음이 아플 때는 나를 둘러싼 현실적 환경—가족 간의 갈등이나 경제적인 어려움, 직장이나 주거 문제 등이 겹쳐서 일상이 더 무겁게 느껴지곤 하죠.\n\n저는 당신이 처한 현실적인 환경과 필요한 사회서비스를 면밀히 '조사'하고, 정부 지원, 맞춤형 복지 혜택, 그리고 당신에게 꼭 맞는 지역사회 전문 기관을 찾아갈 수 있도록 든든하게 '상담·안내하고 연계'해 드리는 역할을 하고 있습니다.",
  
  ot: "조현병, 만성 정신질환, 또는 인지/신체 기능 저하로 인해 무너진 삶의 기능을 다시 회복하는 '정신재활과 자립'을 돕는 요원입니다.\n\n정밀한 '작업 수행 평가'를 통해 주의력과 기억력을 깨우는 컴퓨터/교구 인지치료를 실시하며, 신체적·정신적 기능을 향상시킵니다. 씻기, 옷 입기, 식사하기, 요리하기 같은 기본적이고 독립적인 일상생활(ADL)을 남의 도움 없이 스스로 다시 씩씩하게 해낼 수 있도록 체계적인 생활·작업 훈련을 제공합니다."
};
...
const flow = { 
  q1: { 
    ...
    choices: [ 
      ...
      ["가족, 돈, 일 같은 현실 문제 때문에 혼자 감당하기 버거워요.", { social: SCORE_PER_CHOICE }, { social: ["환경적 스트레스 및 현실적 부담"] }, "q2"], 
      ["예전보다 일상생활을 하는 것이 점점 불편해졌어요.", { ot: SCORE_PER_CHOICE }, { ot: ["작업 수행 및 일상 기능 변화"] }, "q2"], 
      ["지금은 크게 힘든 증상은 없고, 어떤 일을 하는지 둘러보고 싶어요.", {}, {}, "browse"] 
    ] 
  }, 
  q2: { 
    ...
    choices: [ 
      ...
      ["혼자 해결하기 어려운 현실 문제가 계속 쌓이고 있어요.", { social: SCORE_PER_CHOICE }, { social: ["현실적인 위기 상황 가중"] }, "q3"], 
  ...
  q3: { 
    ...
    choices: [ 
      ...
      ["나에게 맞는 지원과 도움을 함께 찾아보고 싶어요.", { social: SCORE_PER_CHOICE }, { social: ["복지서비스 상담 및 자원 연계"] }, "q4"], 
      ["일상생활을 더 편하게 하고, 필요한 기능을 회복하고 싶어요.", { ot: SCORE_PER_CHOICE }, { ot: ["작업 수행 및 기능 회복"] }, "q4"] 
    ] 
  }, 
  q4: { 
    progress: ["장기적 회복 방향", 100], 
    ...
    choices: [ 
      ...
      ["어려울 때 필요한 도움을 꾸준히 받을 수 있었으면 좋겠어요.", { social: SCORE_PER_CHOICE }, { social: ["지속적인 사회적 지원 활용"] }, "finish"], 
...
function showSafetyHall() {
  ...
  dialog(
    ...
    "정신건강전문요원은 보건복지부 국가자격을 취득한 정신건강 전문인력입니다.\n\n" +
    "이 센터에는\n\n" +
    "❤️ 정신건강임상심리사\n" +
    "💊 정신건강간호사\n" +
    "🏠 정신건강사회복지사\n" +
    "🌱 정신건강작업치료사\n\n" +
    "네 분야의 전문가가 함께 일하고 있습니다.\n\n" +
    "모두 마음건강 회복을 돕는다는 공통된 목표를 가지고 있지만, 각자의 전문 분야와 역할은 서로 다릅니다.\n\n" +
    "앞으로 몇 가지 질문을 통해 현재의 나에게 가장 적합한 정신건강전문요원을 함께 찾아보겠습니다.\n\n" +
    "※ 궁금하다면 위의 직역 이름을 눌러 각 전문가가 어떤 역할을 하는지 먼저 둘러볼 수도 있습니다.\n\n" +
    "원활한 안내를 위해 먼저 '안전 확인'을 진행하겠습니다.",
    safetyChoices()
  );
}
...
function showBrowseHall() {
  ...
  dialog(
    "접수 직원",
    "위의 '전문가 이름 버튼' 중 궁금한 요원을 직접 터치하여, 각 전문가가 어떤 일을 하는지 천천히 둘러보세요.",
    []
  );
}
...
function showResult() {
  ...
  // 2. 결과 서브 텍스트 분기 처리 (단일 추천 케이스 추가)
  let heroText = "";
  if (allSameScore) {
  ...
  // 3. 하단 접수 직원 dialog 대사 분기 처리 (단일 추천 케이스 추가)
  let dialogMessage = "";
  if (allSameScore) {
