const FIXED_DESCRIPTIONS = {
  ...
  social: "마음이 아플 때는 나를 둘러싼 현실적 환경—가족 간의 갈등이나 경제적인 어려움, 직장이나 주거 문제 등이 겹쳐서 일상이 더 무겁게 느껴지곤 하죠.\n\n저는 당신이 처한 현실적인 환경과 필요한 사회서비스를 면밀히 '조사'하고, 정부 지원, 맞춤형 복지 혜택, 그리고 당신에게 꼭 맞는 지역사회 전문 기관을 찾아갈 수 있도록 든든하게 안내하고 연계해 드리는 역할을 하고 있습니다.",
...
function shareKakao() {
  ...
  Kakao.Share.sendDefault({
    objectType: "feed",
    content: {
      title: "나에게 맞는 정신건강전문요원 찾기",
      description: "나에게 맞는 정신건강전문요원을 찾아보세요.",
      imageUrl: "https://jeonbomyi.github.io/assets/share/title-preview.png",
      link: {
        mobileWebUrl: "https://jeonbomyi.github.io/",
        webUrl: "https://jeonbomyi.github.io/"
      }
    },
    buttons: [
      {
